        ...
        <div className='infomation_detail_class_content-main'>
          <div className='infomation_detail_class_content-main-left'>
            ...
            }
            {
              toggleState === 3 &&
              <div className='listProgramStudy'>
                <p style={{ fontSize: "16px", fontWeight: "500" }}>Danh mục câu hỏi thi</p>
                {
                  detailClass.exam && detailClass.exam.exam_details.length > 0 ? detailClass.exam.exam_details.map(exam => (
                    <div className='content_ctd_new'>
                      <Card className='card_ctd'>
                        <div className='content_card_new'>
                          <div className='content_exam'>
                            <div>{exam.content_exam_detail}</div>
                          </div>
                          <TextareaAutosize
